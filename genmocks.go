...
const usage = `genmocks [-dir directory] <recv> <iface> <packagename> [override-methods]

genmocks generates a mock file that contains a mock which implements the given interface

Examples:

genmock 'm *mockReader' io.Reader mocks > mocks/reader_mock_gen.go

Don't forget the single quotes around the receiver type
to prevent shell globbing.

override-methods example: "InsideTx:f(ds)" "IsUniqueError:true"
`
...
func main() {
	...
	src := fmt.Sprintf("// Code generated by genmocks.\n// DO NOT EDIT!\n\npackage %s\n\n", packageName)
